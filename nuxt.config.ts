    ...
    head: {
      ...
      meta: [
        ...
        { name: 'viewport', content: 'width=device-width, initial-scale=1' },
        {
          name: 'description',
          content:
            'Farrel AD - Full Stack Developer specializing in web development, mobile apps, machine learning, and cloud computing. View my projects and get in touch.',
        },
        {
          name: 'keywords',
          content:
            'Farrel AD, Full Stack Developer, Web Development, Machine Learning, AI, Nuxt.js, JavaScript, Python, Portfolio',
        },
        ...
        {
          property: 'og:title',
          content: 'Farrel AD - Full Stack Developer & AI Enthusiast',
        },
        {
          property: 'og:description',
          content:
            'Full Stack Developer specializing in web development, mobile apps, machine learning, and cloud computing. View my projects and get in touch.',
        },
      ...
      script: [
        // Structured Data (JSON-LD) for better search engine understanding
        {
          ...
          innerHTML: JSON.stringify({
            ...
            description:
              'Full Stack Developer specializing in web development, mobile apps, machine learning, and cloud computing.',
